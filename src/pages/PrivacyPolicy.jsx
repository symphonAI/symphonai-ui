...
/**
 * Created using https://termsfeed.com
 * TODO: Update to a privacy policy that adheres to
 * CCPA, GDPR guidelines etc. once we get more traffic
 */
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SymphonAI.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SymphonAI, accessible from{" "}
            <a
              href="https://symphon.ai"
      ...
      <ul>
        <li>By email: sjunejo1@gmail.com</li>
      </ul>
    </div>
  );
}
